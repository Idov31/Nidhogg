...
constexpr ULONG IOCTL_PROTECT_HIDE_REGITEM = static_cast<ULONG>(CTL_CODE(0x8000, 0x80D, METHOD_BUFFERED, FILE_ANY_ACCESS));
constexpr ULONG IOCTL_UNPROTECT_UNHIDE_REGITEM = static_cast<ULONG>(CTL_CODE(0x8000, 0x80E, METHOD_BUFFERED, FILE_ANY_ACCESS));
...
constexpr ULONG IOCTL_HIDE_RESTORE_MODULE = static_cast<ULONG>(CTL_CODE(0x8000, 0x814, METHOD_BUFFERED, FILE_ANY_ACCESS));
